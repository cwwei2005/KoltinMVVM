package com.example.common.model.local
...
import com.example.common.model.local.MyDataBase.Companion.DB_VERSION
import com.example.common.model.entity.ArticleEntity
import com.example.common.model.local.dao.ArticleDao
import com.example.common.model.local.dao.SelectDao

/**
 * 数据库创建和表(need entity, dao)
 */
@Database(entities = [ArticleEntity::class, SelectEntity::class], version = DB_VERSION)
